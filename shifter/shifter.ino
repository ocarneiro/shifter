...
const int data_pin = 2; //DS (pino 14 no 595)
const int latch_pin = 3; //STCP (pino 12 no 595)
const int save_pin = 4; //SHCP (pino 11 no 595)
//o pino 13 (OE - pause) foi ligado ao GND
//o pino 10 (MR - Nreset) foi ligado ao VCC
